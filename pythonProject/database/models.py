...
from sqlalchemy import BigInteger, TIMESTAMP, func, String, ForeignKey, Text, Boolean
...
class User(Base):
    ...
    is_full_access: Mapped[bool] = mapped_column(Boolean, default=False)
...
class Recipe(Base):
    ...
    steps = mapped_column(Text, nullable=False)
